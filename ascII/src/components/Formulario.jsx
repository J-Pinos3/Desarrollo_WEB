            ...
            if(idMetro)
            {
                (async function (idMetro) {
                    try {
                        ...
                        const {id,nombre,sector,salida,llegada,maquinista, vehiculo,detalles} = respuesta
                        setform({
                            ...form,
                            nombre,
                            sector,
    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <div>
                <label
                    htmlFor='vehiculo'
                    className='text-gray-700 uppercase font-bold text-sm'>Modelo del vehículo: </label>
                <input
                    id='vehiculo'
                    type="text"
                    className='border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md mb-5'

                ...
                <form>
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            type="text"
                            name="email"
                            className="py-2 px-3 border border-green-500 focus:border-blue-600 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50 rounded-md shadow-sm disabled:bg-gray-100 mt-1 block w-full"
                        />
